    ...
    try:
        with sync_playwright() as p:
            ...
            page.add_init_script("""
                ...
                // Also mask other bot detection properties
            ...
            try:
                page.wait_for_selector('.template-item', timeout=30000)
                print("Template items found!")
            except:
                print("Template items selector not found, waiting a bit more...")
                time.sleep(10)
        ...
        output_file = '/tmp/webpage_content_improved.txt'
